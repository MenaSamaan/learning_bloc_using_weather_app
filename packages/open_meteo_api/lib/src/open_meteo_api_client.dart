...
class OpenMeteoApiClient {
  ...
  Future<Location> locationSearch(String query) async {
    ...
    final locationResults = locationJson['results'] as List;

    if (locationResults.isEmpty) throw LocationNotFoundFailure();

    return Location.fromJson(locationResults.first as Map<String, dynamic>);
  }
  ...
  Future<Weather> getWeather({
    ...
    final weatherResults =
        weatherJson['current_weather'] as Map<String, dynamic>;

    return Weather.fromJson(weatherResults);
  }
}
